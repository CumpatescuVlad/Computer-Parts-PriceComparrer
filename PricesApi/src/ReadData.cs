namespace DataScrapper.src
{
    public static  class ReadData
    {
        ...
        public static string ReadProcessorModel(string webSiteName,string processorModel) => $"Select ComponentTitle , ComponentHyperlink , ComponentPrice From ProcessorTable Where WebSiteName = '{webSiteName}' and ComponentTitle Like '%{processorModel}%'";
