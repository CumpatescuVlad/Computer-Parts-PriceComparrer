namespace PriceComparrerDemo
{
    public static class DatabaseInfo
    {
        ...
        public static string ReadExistingData(string tableName, string webSiteName) => $"Select ComponentTitle,ComponentHyperlink from {tableName} where WebSiteName='{webSiteName}'";
